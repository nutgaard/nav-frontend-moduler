...
const cls = (className) => classNames('skjemaelement', 'textarea__container', className);
...
class Textarea extends Component {
    ...
    render() {
        const { label, maxLength, textareaClass, id, name, feil, tellerTekst, textareaRef, className, ...other } =
            this.props;
